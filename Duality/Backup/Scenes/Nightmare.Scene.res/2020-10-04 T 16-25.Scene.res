          ...
          <_items dataType="Array" type="Duality.Resources.PrefabLink+VarMod[]" id="881426276" length="4">
            ...
            <item dataType="Struct" type="Duality.Resources.PrefabLink+VarMod">
              <childIndex dataType="Struct" type="System.Collections.Generic.List`1[[System.Int32]]" id="931742004">
                <_items dataType="ObjectRef">996946540</_items>
                <_size dataType="Int">0</_size>
              </childIndex>
              <componentType dataType="ObjectRef">1769068990</componentType>
              <prop dataType="MemberInfo" id="1062956834" value="P:Duality_.Tag:iD" />
              <val dataType="Enum" type="Duality_.Tag+ID" name="APPLE" value="2" />
            </item>
          </_items>
